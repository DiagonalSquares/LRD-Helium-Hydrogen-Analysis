...
for filename in data_files:
    try:
        name = get_id(filename)
        H1_flux = read_json("../json_files/flux.json", filename, "Flux")
        H1_flux_error = read_json("../json_files/flux.json", filename, "Flux Error")
...
print("data:", data)
write_data_to_json(data, "../json_files/flux_error.json")
