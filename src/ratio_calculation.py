...
density_range = np.logspace(8, 13, num=STEPS)
...
for filename in data_files:
    try:
        measured_H1 = read_json("../json_files/flux.json", str(filename), "Flux")
...
for filename in data_files:
    try:
        positive_errors.append(read_json("../json_files/flux_error.json", filename, "Positive Error"))
        negative_errors.append(read_json("../json_files/flux_error.json", filename, "Negative Error"))
    except:
        print("something went wrong")

print("positive_errors:", positive_errors)
print("negative_errors:", negative_errors)
print("nearest_temeperatures:", nearest_temeperatures)
